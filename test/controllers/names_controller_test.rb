...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { description: @name.description, project_id: @name.project_id, status: @name.status } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { description: @name.description, project_id: @name.project_id, status: @name.status } }
